...
if Check_empty.check_value_is_empty(id)== True or Check_number.check_value_is_number(id)== False :
    print("enter a valid id")
     ...
     if Search_controller.check_if_client_exsist(id)==True:
             ...
             print("not valid number")
              ...
              if choice=="1":
                 ...
                 print("available books are:\n",Lists.Lists.display_available_books())
                   ...
                   identity=input("\n \n To add new client to this list give me client information:\n"
                                  "enter the new client identity:\t")
                   ...
                   print("\n \n Your new client list become as follow")
                   Lists.Lists.get_Client_list() # this for clarifying after adding
              else:
         ...
         print("the id does not exist run the program again")